...
#define MATCH_NICREAD 0xb
#define MASK_NICREAD  0xfe00707f
#define MATCH_NICWRITE 0x200b
#define MASK_NICWRITE  0xfe00707f
...
DECLARE_INSN(nicread, MATCH_NICREAD, MASK_NICREAD)
DECLARE_INSN(nicwrite, MATCH_NICWRITE, MASK_NICWRITE)
